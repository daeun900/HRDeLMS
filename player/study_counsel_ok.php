...
$Sql = "INSERT INTO Counsel(ID, Name, Mobile, Email, LectureCode, Study_Seq, Contents_idx, Category, Title, Contents, Status, Del, RegDate, ViewCount) 
        SELECT '$LoginMemberID', M.Name, M.Mobile, M.Email, '$LectureCode', $Study_Seq, $Contents_idx, '$Category', '$Title', '$Contents', 'A', 'N', NOW(), 0
        FROM Member AS M
