                ...
                <div class="">
                	...
                	<div class="panViewArea mt15">
                        ...
                        <ul class="viewInfo">
							...
							<li class="file">
                				<?if($FileName1) { ?><p><a href="https://www.hrdeedu.com/include/download.php?idx=<?=$idx?>&code=Notice&file=1"><span class="fcSky01">[첨부] </span><?=$RealFileName1?></a></p><?}?>
                				<?if($FileName2) { ?><p><a href="https://www.hrdeedu.com/include/download.php?idx=<?=$idx?>&code=Notice&file=2"><span class="fcSky01">[첨부] </span><?=$RealFileName2?></a></p><?}?>
								<?if($FileName3) { ?><p><a href="https://www.hrdeedu.com/include/download.php?idx=<?=$idx?>&code=Notice&file=3"><span class="fcSky01">[첨부] </span><?=$RealFileName3?></a></p><?}?>
								<?if($FileName4) { ?><p><a href="https://www.hrdeedu.com/include/download.php?idx=<?=$idx?>&code=Notice&file=4"><span class="fcSky01">[첨부] </span><?=$RealFileName4?></a></p><?}?>
								<?if($FileName5) { ?><p><a href="https://www.hrdeedu.com/include/download.php?idx=<?=$idx?>&code=Notice&file=5"><span class="fcSky01">[첨부] </span><?=$RealFileName5?></a></p><?}?>
                			</li>
							<?}?>
                			<!-- file // -->
                            <!-- txt -->
