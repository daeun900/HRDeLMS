				...
				*/
				...
				if(ConnStatus == "101") {
					if(OtpStatus == "101" || OtpStatus == "103") {
						...
						location.href="lecture_view.php?Chapter_Number="+Chapter_Number+"&LectureCode="+LectureCode+"&Study_Seq="+Study_Seq+"&Chapter_Seq="+Chapter_Seq+"&Contents_idx="+Contents_idx+"&mode="+mode+"&OptInit=Y";
					}
					else {
