...
if($_SESSION['LoginMemberID']) {
    ...
    //$sso_id = "B01".$sso_id;
?>
<form method="post" name="frmsso" action="https://m.hrdesafe.com/loginsso_id.php">
...
?>
                            <li>
                            	<a href="javascript:void(0);" onClick="javascript:goSSO();" target="_blank" style="font-size:17px; color:#757575;">
                                    ...
                                    <div class="checkArea">
                                        <dl>
                                            <dt>학습 사이트</dt>
                                            <dd class="notxt"><strong>▶ 바로가기</strong></dd>
                                        </dl>
                                    </div>
								</a>
                            </li>
