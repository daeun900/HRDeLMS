...
include "/home/LMS/public_html/include/include_function_cron.php";
		...
		$toaddress = $Email;
		$body = $Massage;
		$body = $Massage."<img src='http://hrd.ek3434.com/lib/EmailRecive/email_recive.php?num=".$maxno."' width='0' height='0'>";
		$fromname = $SiteName;
		...
		$send = nmail($fromaddress, "jeankie@nanuly.kr", $subject, $body, $fromname);
echo $send;
		$send = nmail($fromaddress, "83nodengi@naver.com", $subject, $body, $fromname);
echo $send;
