...
<?php
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////    
	...
	$sModulePath				= "/home/LMS/lib/NiceIPIN/64bit/IPIN2Client";
...
<?
	...
	//인증성공시 인증내역에 저장
	$maxno = max_number("Seq","UserCert");
	$CertDate = date("Y-m-d");
	$CertType = "ipin";
	$Sql = "INSERT INTO UserCert(Seq, ID, LectureCode, CertDate, CertType, RegDate) VALUES($maxno, '$LoginMemberID', '$strResultCode', '$CertDate', '$CertType', NOW())";
	$Row = mysql_query($Sql);
