...
$Sql = "SELECT * FROM CourseCyber WHERE LectureCode='$LectureCode' AND Del='N'";
...
<div class="btnAreaTl02">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;<?if($AdminWrite=="Y") {?><input type="button" value="추가 하기" class="btn_inputLine01" onclick="ChapterRegist('new','<?=$LectureCode?>','','Y', 'CourseCyber');"><?}?>
</div>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" style="margin-top:20px">
	<tr>
		<td valign="top" align="left">
			...
			<input type="button" value="사업주훈련 차시 정보 가져오기" onclick="ChapterCopy('<?=$LectureCode?>')" class="btn_inputLine01"><?}?>
		</td>
	</tr>
</table>
