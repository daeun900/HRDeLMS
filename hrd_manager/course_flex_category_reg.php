...
if($mode=="Edit") {
	$Sql = "SELECT * FROM CourseFlexCategory WHERE idx=$idx";
...
if($ParentCategory) {
	$Sql = "SELECT * FROM CourseFlexCategory WHERE idx=$ParentCategory";
	$Result = mysqli_query($connect, $Sql);
	$Row = mysqli_fetch_array($Result);
	if($Row) {
...
if(!$OrderByNum) {
	...
	$query_select = "SELECT MAX(OrderByNum) FROM CourseFlexCategory $OrderByNumWhere";
...
<div id="wrap">
	<div class="Content">
        <div class="contentBody">
            ...
            <div class="conZone">
				<form name="Form1" method="post" action="course_flex_category_reg_script.php">
