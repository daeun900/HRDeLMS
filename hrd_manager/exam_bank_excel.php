...
<div class="contentBody">
	...
	<div class="conZone">
    	...
    	<br><span class="redB">* 엑셀업로드시, 아래의 안내에 맞게 입력했는지 확인 부탁드립니다. *</span>
    	<br><span class="red"> - 차시 → 문항번호와 동일 입력</span>
    	<br><span class="red"> - 유형 → A:객관식/B:단답형/c:서술형</span>
    	<br><span class="red"> - 중간,최종 → mid:중간평가/final:최종평가/report:과제</span>
