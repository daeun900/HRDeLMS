	...
	<div class="contentBody">
		...
		<div class="conZone">
			...
			<tr>
				...
				<td align="center" class="text01"><a href="Javascript:CourseCyberCopyApply('<?=$LectureCode?>');"><img src="images/btn_select.gif"></a></td>
              </tr>
			<?
			      $i++;
				}
			...
			<form name="CourseCyberCopyForm" action="course_cyber_copy_apply.php" target="ScriptFrame">
