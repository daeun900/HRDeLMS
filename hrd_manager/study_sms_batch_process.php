...
if($send_mode=="sms") {
	...
	$etc1 = $maxno;
	$Sql = "INSERT INTO SmsSendLog(idx, ID, Study_Seq, Massage, Code, Mobile, InputID, RegDate) VALUES($maxno, '$ID', $Seq, '$TemplateMessage', '', '$phone', '$LoginAdminID', NOW())";
	$Row = mysqli_query($connect, $Sql);
	
	$send = mts_mms_send($phone, $TemplateMessage, $callback, $etc1, $TemplateCode);
