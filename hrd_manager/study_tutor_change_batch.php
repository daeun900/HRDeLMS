...
$Colume = "a.Seq, a.ServiceType, a.ID, a.LectureStart, a.LectureEnd, a.Progress, a.MidStatus, a.MidSaveTime, a.MidScore, a.TestStatus, a.TestScore, a.TestSaveTime, a.ReportStatus, a.ReportSaveTime,
		a.ReportScore, a.TotalScore, a.PassOK, a.certCount, a.StudyEnd, a.PackageRef, a.PackageGroupNo, a.OpenChapter, a.Tutor, 
...
function ChangeBatch() {
	...
	var Tutor = $("#Tutor").val();
	var Tutor_text = $("#Tutor option:selected").text();
...
function BatchProcess(i) {
	...
	if(i<totalcount) {
		...
		if ($("input:checkbox[id='check_seq_"+i+"']").is(":checked") == false){
			...
			$("div[id='status']:eq("+i+")").load('./study_tutor_change_batch_process.php',
		...
		<div class="Content">
	        <div class="contentBody">
        	    ...
        	    <div class="conZone">
    				...
    				<select name="Tutor" id="Tutor" style="width:200px; height:35px">
    					<option value="">교강사 선택</option>
    					<?
    					$SQL2 = "SELECT * FROM StaffInfo WHERE Dept='C' AND Del='N' ORDER BY Name ASC, ID ASC";
