...
//-->
        ...
        <div class="contentBody">
            ...
            <div class="conZone">
                ...
                <!-- 내용 -->
				<form name="DeleteForm" method="post" action="staff01_script.php" target="ScriptFrame">
					<INPUT TYPE="hidden" name="mode" value="del">
					<INPUT TYPE="hidden" name="idx" value="<?=$idx?>">
				</form>
				<form name="PasswordForm" method="post" action="staff01_script.php" target="ScriptFrame">
