	...
	<div class="Content">
        ...
        <div class="contentBody">
            ...
            <div class="conZone">
				...
				<form name="InformationProtectionForm" method="post" action="Information_protection_regist_ok.php" target="ScriptFrame">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="gapT20">
					<tr>
						...
						<td align="center"><input type="button" value="등록 하기" onclick="InformationProtectionSubmitOk();" class="btn_inputBlue01"></td>
