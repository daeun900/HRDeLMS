        ...
        <div class="contentBody">
            ...
            <div class="conZone">
				...
				<div class="btnAreaTl02">
					<span class="fs16b fc333B sub_title2">관리자</span>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" name="Btn" id="Btn" class="btn btn_Blue" onclick="DeptAdd('A','','0','0','','New');">하부 카테고리 추가</button>
              	</div>
                  ...
                  <tr>
					...
					?>
							<TR>
								...
								<TD style="font-size:15px; border:0px">&nbsp;&nbsp;
									<button type="button" class="btn round btn_LGray line" onclick="DeptAdd('<?=$Dept?>','<?=$idx?>','<?=$ParentCategory?>','<?=$Deep?>','<?=$DeptString?>','Edit');"><i class="xi-folder-remove-o"></i> 수정</button>&nbsp;
									<button type="button" class="btn round btn_LBlue line" onclick="DeptAdd('<?=$Dept?>','<?=$idx?>','<?=$idx?>','<?=$Deep?>','<?=$DeptString?>','New');"><i class="xi-folder-add-o"></i> 하부 카테고리 추가</button>
								</TD>
							</TR>
							<TR>
				...
				<div class="btnAreaTl02">
					<span class="fs16b fc333B sub_title2">영업자</span>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" name="Btn" id="Btn" class="btn btn_Blue" onclick="DeptAdd('B','','0','0','','New');">하부 카테고리 추가</button>
              	</div>
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 mt20">
                  <tr>
                    <td align="left">
				...
				<div class="btnAreaTl02">
					<span class="fs16b fc333B sub_title2">첨삭강사</span>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" name="Btn" id="Btn" class="btn btn_Blue" onclick="DeptAdd('C','','0','0','','New');">하부 카테고리 추가</button>
              	</div>
                <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 mt20">
                  <tr>
                    <td align="left">
				...
				<div class="btnAreaTl02">
					<span class="fs16b fc333B sub_title2">영업부서 정렬</span>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" name="Btn" id="Btn" class="btn btn_Blue" onclick="DeptOrderBy();">정렬 하기</button>
              	</div>
