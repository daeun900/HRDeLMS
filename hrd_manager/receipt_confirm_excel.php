...
if($QUERY && mysqli_num_rows($QUERY))
{
	while($ROW = mysqli_fetch_array($QUERY))
	{
		...
		$objPHPExcel->getActiveSheet()->getCell('G'.$k)->setValueExplicit(number_format($Price,0), PHPExcel_Cell_DataType::TYPE_STRING);
...
$objPHPExcel->getActiveSheet()->getCell('A'.$k2)->setValue('총훈련비합계');
