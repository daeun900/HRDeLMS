...
?>
                ...
                <!-- 입력 -->
				<form name="Form1" method="post" action="staff01_script.php" target="ScriptFrame">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="view_ty01">
                  ...
                  <tr>
                    <th>카테고리</th>
                    <td><span id="DeptCategorySelected"></span>&nbsp;<button type="button" onclick="DeptCategorySelect('A');" class="btn round btn_LBlue line"><i class="xi-folder-open"></i> 카테고리 찾기</button></td>
                  </tr>
				  <?if($mode=="new") {?>
				  <tr>
                    <th>아이디</th>
