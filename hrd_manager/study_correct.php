		...
		<div class="conZone">
			...
			<form name="search" id="search" method="POST">
    			...
    			<div class="neoSearch">
    				<ul class="search">
    					<li>
    						<span class="item01">수강기간 및 사업주</span>&nbsp;
    				...
    				<div class="mt10 tc pb5">
                    	<button type="button" name="SearchBtn" id="SearchBtn" class="btn btn_Blue" style="width:200px;" onclick="StudyCorrectSearch(1)"><i class="fas fa-search"></i> 검색</button>&nbsp;&nbsp;	
    					<button type="button" name="ExcelBtn" id="ExcelBtn" class="btn btn_Green line" style="width:200px;" onclick="StudyCorrectExcel();"><i class="fas fa-file-excel"></i> 검색 결과 엑셀 출력</button>
    				</div>
    			</div>
    		</form>
    		<!-- //검색 -->
