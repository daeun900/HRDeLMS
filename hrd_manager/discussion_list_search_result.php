...
$Colume = "a.Seq, a.ServiceType, a.ID, a.LectureStart, a.LectureEnd, a.Progress, a.MidStatus, a.MidSaveTime, a.MidScore, a.TestStatus, a.TestScore, a.TestSaveTime, a.ReportStatus, a.ReportSaveTime,
		   ...
		   COALESCE(b.ContentsName, bc.ContentsName) AS ContentsName,
		   COALESCE(b.MidRate, bc.MidRate) AS MidRate, 
		   COALESCE(b.TestRate, bc.TestRate) AS TestRate, 
		   COALESCE(b.ReportRate, bc.ReportRate) AS ReportRate, 
           c.Name, c.Depart, 
		   d.CompanyName, 
...
$JoinQuery = " Study AS a 
                ...
                LEFT OUTER JOIN CourseCyber AS bc ON a.LectureCode=bc.LectureCode 
				...
				LEFT OUTER JOIN DiscussionAnswer AS da ON da.Chapter_Seq = ca.Seq  AND da.ID = a.ID";
