		...
		<div class="conZone">
			...
			<div id="LoginHistory" style="left:10px; top:20px; width:100%; height:200px; z-index:1; overflow: auto; overflow-x:hidden;">
				<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
        			...
        			<?
        			$i = 1;
        			$SQL = "SELECT DISTINCT a.LectureStart, a.LectureEnd FROM Study AS a LEFT OUTER JOIN Company AS b ON a.CompanyCode=b.CompanyCode WHERE a.CompanyCode='$CompanyCode' AND a.ServiceType IN (1,3,5) ORDER BY a.LectureStart ASC, a.LectureEnd ASC";
			...
			<div id="StudyHistory" style="left:10px; top:20px; width:100%; height:400px; z-index:1; overflow: auto; overflow-x:hidden;">
        		<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
        			<tr>
        				<th>번호<br />구분</th>
        				<th>이름<br />ID</th>
        			...
        			<tr >
        				...
        				<td align="center" class="text01"><?=$Name?><br /><?=$ID?></td>
        				<td align="center" class="text01">
        					<?=$ContentsName?><br />
            				<?=$LectureStart?> ~ <?=$LectureEnd?><br />
            				첨삭완료 : <?=date("Y-m-d", $Tutor_limit_day)?>까지
            			</td>
        				<td align="center" class="text01"><?=$Progress?>%</td>
        				<td align="center" class="text01"><?=$Mid_View?></td>
        				<td align="center" class="text01"><?=$Test_View?></td>
        				<td align="center" class="text01"><?=$Report_View?></td>
        				<td align="center" class="text01"><?=$TotalScore_View?><br /><?=$PassOK_View?></td>
        				<td align="center" class="text01"><?=$TutorName?></td>
        				<td align="center" class="text01"><?=$CompanyName?><?if($Depart) {?><br />부서 : <?=$Depart?><?}?></td>
        				<td align="center" class="text01"><?=$certCount?></td>
        			</tr>
        			<?
        			         $i++;
        				}
        			...
        			?>
        			<tr>
        				<td height="28"  colspan="20">수강 내역이 없습니다.</td>
        			</tr>
        			<? } ?>
				</table>
        	</div>
