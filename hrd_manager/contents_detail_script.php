...
if($mode=="new") {
	...
	$Sql = "INSERT INTO ContentsDetail (Seq, Contents_idx, ContentsType, ContentsPage, ContentsMobilePage, ContentsURLSelect, ContentsURL, ContentsURL2, MobileURL, MobileURL2, 
