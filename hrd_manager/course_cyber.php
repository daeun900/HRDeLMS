...
##-- 검색 등록수
$Sql = "SELECT COUNT(*) FROM CourseCyber AS a  $where";
	...
	<div class="contentBody">
		...
		<div class="conZone">
        	...
        	<div class="btnAreaTr02">
        		<button type="button" name="ExcelBtn" id="ExcelBtn" class="btn btn_Green line" style="width:200px;" onclick="CourseCyberExcel();"><i class="fas fa-file-excel"></i> 검색 항목 엑셀 출력</button>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
				...
				<?
				$SQL = "SELECT a.*  FROM CourseCyber a 
				...
				?>
              	<tr>
					...
					<td><A HREF="Javascript:readRun('<?=$idx?>');"><?=$ServiceTypeCourse2_array[$ServiceType]?></A></td>
					<td class="tl"><A HREF="Javascript:readRun('<?=$idx?>');"><strong><?=$ContentsName?></strong></A></td>
