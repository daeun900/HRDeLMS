        ...
        <div class="conZone">
			...
			<div id="LoginHistoryA" style="left:10px; top:20px; width:100%; height:400px; z-index:1; overflow: auto; overflow-x:hidden;">
    			<table width="100%" cellpadding="0" cellspacing="0" class="list_ty01 gapT20">
                    ...
                    if($SearchYear == 'all'){
                        $where = "WHERE a.CompanyCode='$CompanyCode' AND a.ServiceType IN (1,3,5) ";
                    }else{
                        $where = "WHERE a.CompanyCode='$CompanyCode' AND a.ServiceType IN (1,3,5) AND YEAR(a.LectureStart)= '$SearchYear' ";
                    }
