...
$downloadUrlA = $SiteURL."/include/certificate_all_pdf03.php?LectureStart= $LectureStart&LectureEnd=$LectureEnd&CompanyName=$CompanyName&ServiceType=$ServiceType";
$downloadUrlB = $SiteURL."/include/study_end_all_doc03.php?LectureStart=$LectureStart&LectureEnd=$LectureEnd&ServiceType=$ServiceType&CompanyName=$CompanyName";

//[3]메일형식 작성 
$subject = "[".$SiteName."] 훈련결과보고서 및 수료증 발송_교육담당자님 귀하";
