...
function DelOk() {
	...
	del_confirm = confirm("현재 영업자를 삭제하시겠습니까?");
	if(del_confirm==true) {
		DeleteForm.submit();
	}
}
...
//-->
        ...
        <div class="contentBody">
            ...
            <div class="conZone">
                ...
                <!-- 내용 -->
				<form name="DeleteForm" method="post" action="staff02_script.php" target="ScriptFrame">
					<INPUT TYPE="hidden" name="mode" value="del">
					<INPUT TYPE="hidden" name="idx" value="<?=$idx?>">
				</form>
				<form name="PasswordForm" method="post" action="staff02_script.php" target="ScriptFrame">
				...
				<div class="btnAreaTc02">
					...
					<button type="button" class="btn btn_Blue" onclick="ManagerLoginSubmit('<?=$ID?>')">현재 아이디로 로그인</button>
