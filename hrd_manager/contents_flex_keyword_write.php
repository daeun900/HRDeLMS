...
$Sql = "SELECT * FROM ContentsFlexKeyword WHERE idx=$idxA";
...
?>
	<div class="contentBody">
    	<h2>컨텐츠 키워드 <?=$ScriptTitle?></h2>
            <div class="conZone">
			<form name="DeleteForm" method="post" action="contents_flex_keyword_script.php" target="ScriptFrame">
				<INPUT TYPE="hidden" name="mode" value="del">
				<INPUT TYPE="hidden" name="idx" value="<?=$idx?>">
				<INPUT TYPE="hidden" name="Category" value="<?=$cat?>">
			</form>
            <!-- 입력 -->
			<form name="Form1" method="post" action="contents_flex_keyword_script.php" enctype="multipart/form-data" target="ScriptFrame">
